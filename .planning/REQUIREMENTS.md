...
- [ ] **HAB-02**: User can check off habits daily with a single click/keystroke
- [ ] **HAB-03**: User can see current streak and best streak per habit
- [ ] **HAB-04**: User can view completion history (last 7/30 days)
- [ ] **HAB-05**: User can schedule habits for specific days of the week
...
- [ ] **PLAN-01**: User can create tasks with a title and optional notes
- [ ] **PLAN-02**: User can check off and delete tasks
- [ ] **PLAN-03**: User can assign tasks to specific dates
- [ ] **PLAN-04**: User can navigate between days (past and future)
- [ ] **PLAN-05**: User can reorder tasks within a day
...
- [ ] **PLAN-09**: User can write freeform daily notes per day
...
- [ ] **EXP-06**: User can create wallets with balances
- [ ] **EXP-07**: Logging an expense auto-deducts from the selected wallet
- [ ] **EXP-08**: User can manually adjust wallet balances
...
- [ ] **SHELL-04**: Sub-100ms transitions, no loading spinners
